...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="../css/login/reset.css" charset="utf-8">
        <link rel="stylesheet" href="../css/login/supersized.css" charset="utf-8">
        <link rel="stylesheet" href="../css/login/style.css" charset="utf-8">
    ...
    <body oncontextmenu="return false">
        ...
        <script src="../js/business/login/supersized.3.2.7.min.js" charset="utf-8"></script>
        <script src="../js/business/login/supersized-init.js" charset="utf-8"></script>
		<script>
		$(".btn").click(function(){
			is_hide();
		})
		...
		$("#submit").live('click',function(){
			...
			window.location.href='http://127.0.0.1/websocket/';
		});
